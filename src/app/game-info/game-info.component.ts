...
export class GameInfoComponent implements OnInit, OnChanges {
  ...
  cardAction = [
    ...
    { title: 'Thumbmaster', description: 'The player to draw this card is now the thumb master, whenever this player puts their thumb on the table all players must follow suit, the last player to do so must drink.' },
